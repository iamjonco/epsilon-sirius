 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.sirius.examples.filesystem.impl.SyncImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.eclipse.epsilon.sirius.examples.filesystem.impl.SyncImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.eclipse.epsilon.sirius.examples.filesystem.impl.SyncImpl#getLastSync <em>Last Sync</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SyncImpl extends MinimalEObjectImpl.Container implements Sync {
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FilesystemPackage.SYNC__SOURCE, oldSource,
							source));
			}
		}
		return source;
	...
	public File getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FilesystemPackage.SYNC__TARGET, oldTarget,
							target));
			}
		}
		return target;
	...
	public void setLastSync(String newLastSync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FilesystemPackage.SYNC__LAST_SYNC, oldLastSync,
					lastSync));
	}
