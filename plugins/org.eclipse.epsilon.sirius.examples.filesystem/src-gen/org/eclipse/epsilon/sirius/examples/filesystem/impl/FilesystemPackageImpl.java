...
import org.eclipse.epsilon.sirius.examples.filesystem.Drive;
import org.eclipse.epsilon.sirius.examples.filesystem.File;
import org.eclipse.epsilon.sirius.examples.filesystem.Filesystem;
import org.eclipse.epsilon.sirius.examples.filesystem.FilesystemFactory;
import org.eclipse.epsilon.sirius.examples.filesystem.FilesystemPackage;
import org.eclipse.epsilon.sirius.examples.filesystem.Folder;
import org.eclipse.epsilon.sirius.examples.filesystem.Shortcut;
import org.eclipse.epsilon.sirius.examples.filesystem.Sync;
...
public class FilesystemPackageImpl extends EPackageImpl implements FilesystemPackage {
	 ...
	 * @see org.eclipse.epsilon.sirius.examples.filesystem.FilesystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static FilesystemPackage init() {
		...
		FilesystemPackageImpl theFilesystemPackage = (FilesystemPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof FilesystemPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEClass(filesystemEClass, Filesystem.class, "Filesystem", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFilesystem_Drives(), this.getDrive(), null, "drives", null, 0, -1, Filesystem.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFilesystem_Syncs(), this.getSync(), null, "syncs", null, 0, -1, Filesystem.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFolder_Contents(), this.getFile(), null, "contents", null, 0, -1, Folder.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(shortcutEClass, Shortcut.class, "Shortcut", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getShortcut_Target(), this.getFile(), null, "target", null, 0, 1, Shortcut.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(syncEClass, Sync.class, "Sync", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSync_Source(), this.getFile(), null, "source", null, 0, 1, Sync.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getSync_Target(), this.getFile(), null, "target", null, 0, 1, Sync.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSync_LastSync(), ecorePackage.getEString(), "lastSync", null, 0, 1, Sync.class, !IS_TRANSIENT,
	...
	protected void createGmfAnnotations() {
		...
		addAnnotation(filesystemEClass, source, new String[] {});
	}
	...
	protected void createGmf_1Annotations() {
		...
		addAnnotation(getFolder_Contents(), source, new String[] {});
	}
	...
	protected void createGmf_2Annotations() {
		...
		addAnnotation(getShortcut_Target(), source, new String[] { "target.decoration", "arrow", "style", "dash" });
		addAnnotation(syncEClass, source, new String[] { "label", "lastSync", "source", "source", "target", "target",
				"style", "dot", "width", "2" });
	}
	...
	protected void createGmf_3Annotations() {
		...
		addAnnotation(fileEClass, source, new String[] { "label", "name" });
	}
